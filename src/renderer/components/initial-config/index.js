    ...
    return (
      <div id="initial-config">
        <form onSubmit={this.handleSubmit} className="p-20">
          <input type="text" value={this.state.pythonBinary} onChange={this.handleChangePython} placeholder="Enter path to Python executable" className="mb-40 block full-width" />
          <input type="text" value={this.state.spotdlScript} onChange={this.handleChangeSpotdl} placeholder="Enter path to spotdl.py script" className="mb-40 block full-width" />
